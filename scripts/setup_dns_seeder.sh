...
echo ""
echo "📋 Next steps:"
echo "   1. Check the logs to see your public IP:"
echo "      journalctl --user -u spirachain-seeder-${NETWORK} -n 50"
echo ""
echo "   2. Configure DNS records on your domain provider"
echo "      (Cloudflare, DuckDNS, etc.) with the IPs shown in logs"
echo ""
echo "   3. Your DNS seed will be auto-discovered by the network!"
echo ""
